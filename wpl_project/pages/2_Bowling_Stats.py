"""WPL Data Explorer - Bowling Statistics page."""
...
with col1:
    min_wickets = st.slider("Minimum Wickets", 0, 30, 5, key="top_wickets_min")
with col2:
    min_matches_bowl = st.slider("Minimum Matches", 1, 30, 5, key="top_wickets_matches")
...
econ_min_wickets = st.slider("Minimum Wickets for Economy", 5, 30, 10, key="econ_min_wickets")
...
avg_min_wickets = st.slider("Minimum Wickets for Average", 5, 30, 10, key="avg_min_wickets")
...
sr_min_wickets = st.slider("Minimum Wickets for Strike Rate", 5, 30, 10, key="sr_min_wickets")
