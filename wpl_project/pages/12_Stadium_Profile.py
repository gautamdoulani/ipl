"""WPL Data Explorer - Stadium Profile page."""
...
if selected_venue:
    ...
    with tab3:
        ...
        top_bowlers = run_query(f"""
            ...
            WHERE m.venue = '{selected_venue}'
            GROUP BY d.bowler
            HAVING SUM(CASE WHEN d.is_wicket AND d.wicket_kind NOT IN ('run out', 'retired hurt', 'retired out', 'obstructing the field') THEN 1 ELSE 0 END) >= 3
