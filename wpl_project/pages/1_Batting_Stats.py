"""WPL Data Explorer - Batting Statistics page."""
...
with col1:
    min_runs = st.slider("Minimum Runs", 0, 1000, 50, key="top_runs_min")
with col2:
    min_matches = st.slider("Minimum Matches", 1, 50, 5, key="top_runs_matches")
...
sr_min_runs = st.slider("Minimum Runs for Strike Rate", 50, 500, 100, key="sr_min_runs")
...
avg_min_runs = st.slider("Minimum Runs for Average", 50, 500, 100, key="avg_min_runs")
