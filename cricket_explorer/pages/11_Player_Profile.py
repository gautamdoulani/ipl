"""Cricket Data Explorer - Player Profile page."""
    ...
    with tab1:
        ...
        if len(batting_stats) > 0 and batting_stats['balls'].iloc[0] > 0:
            ...
            if len(bowlers_faced) > 0:
                st.dataframe(bowlers_faced, width="stretch", hide_index=True)
        else:
    ...
    with tab2:
        ...
        if len(bowling_stats) > 0 and bowling_stats['balls'].iloc[0] > 0:
            ...
            if len(batsmen_bowled) > 0:
                st.dataframe(batsmen_bowled, width="stretch", hide_index=True)
        else:
